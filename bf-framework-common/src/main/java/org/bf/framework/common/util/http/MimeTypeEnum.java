...
@Getter
@AllArgsConstructor
public enum MimeTypeEnum implements IdStringEnum {
   ...
   //扩展名
    ...
    private static final String DEFAUL_CONTENT_TYPE = "application/octet-stream";

    /**
     * 通过扩展名获取枚举类型
     */
    public static String getContentType(String fileType) {
        MimeTypeEnum mimeTypeEnum = IdStringEnum.of(fileType, MimeTypeEnum.class);
        if (mimeTypeEnum != null) {
            return mimeTypeEnum.getMimeType();
        }
        return DEFAUL_CONTENT_TYPE;
    }
}
